...
def init(root, total_parts, part_idx):
    filepath = f'{root}/filtered_issue.jsonl'
    ...
    for line in tqdm(lines, desc=f"Processing part {part_idx+1}/{total_parts}"):
...
if __name__ == '__main__':
    ...
    parser.add_argument("--root", type=str, default="/Users/bytedance/Documents/patch_verifier/data/datasets", 
