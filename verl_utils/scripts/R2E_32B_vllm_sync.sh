...
export EXPERIMENT_NAME='R2E_32B'
...
train_files="['$ROOT_DIR/datasets/data_train_gen_simple.parquet']"
test_files="['$ROOT_DIR/datasets/data_test_gen_simple.parquet']"

mkdir /opt/tiger/patch_verifier/workspace
tool_root_path=/mnt/bn/trae-research-models/xujunjielong/datasets/benchmarks
...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.rollout.enable_write=true \
